...
public final class Constants {
    ...
    public static final class DriveConstants {
        ...
        // Spark Max IDs 
        public static final int kFrontLeftDriveMotorPort = 8; //TODO: Decide what this ID needs to be
        public static final int kFrontRightDriveMotorPort = 6; //TODO: Decide what this  ID needs to be
        public static final int kBackLeftDriveMotorPort = 7; //TODO: Decide what this  ID needs to be
        public static final int kBackRightDriveMotorPort = 11; //TODO: Decide what this  ID needs to be
        
        public static final int kFrontLeftSteerMotorPort = 14; //TODO: Decide what this  ID needs to be
        public static final int kFrontRightSteerMotorPort = 1; //TODO: Decide what this ID needs to be
        public static final int kBackLeftSteerMotorPort = 10; //TODO: Decide what this  ID needs to be
        public static final int kBackRightSteerMotorPort = 13; //TODO: Decide what this ID needs to be
        
        public static final int kFrontLeftAbsoluteEncoderPort = 5; //TODO: Decide what this ID needs to be
        public static final int kFrontRightAbsoluteEncoderPort = 4; //TODO: Decide what this ID needs to be
        public static final int kBackLeftAbsoluteEncoderPort = 3; //TODO: Decide what this ID needs to be
        public static final int kBackRightAbsoluteEncoderPort = 2; //TODO: Decide what this ID needs to be
